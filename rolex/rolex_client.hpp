          ...
          ssched.spawn([send_buf, &rpc, &sender, &recv_s, lkey, 
            ...
            while(running) {
              ...
              if(d <= BenConfig.read_ratio) {    // search
                KeyType dummy_key = bench_keys[query_i % exist_keys.size()];
                ...
                KeyType dummy_key = bench_keys[update_i % exist_keys.size()];
                ...
                KeyType dummy_key = bench_keys[remove_i % exist_keys.size()];
